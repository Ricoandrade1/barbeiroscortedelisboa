      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <Card className="p-6">
            ...
            <p className="text-3xl font-bold mt-2">{products.reduce((sum, p) => sum + p.stock, 0) || 0}</p>
            <p className="text-sm text-muted-foreground mt-1">
              {products.filter(p => p.stock < 10).length || 0} precisam reposição
            </p>
          </Card>
          <Card className="p-6">
            <h3 className="text-lg font-medium">Barbeiros Ativos</h3>
            <p className="text-3xl font-bold mt-2">{barbers.length || 0}</p>
            <p className="text-sm text-muted-foreground mt-1">2 em serviço agora</p>
          </Card>
          <Card className="p-6">
            <h3 className="text-lg font-medium">Total a Pagar</h3>
            <p className="text-3xl font-bold mt-2">€{totalBalance.toFixed(2) || "0,00"}</p>
